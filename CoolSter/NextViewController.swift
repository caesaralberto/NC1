...
class NextViewController: UIViewController {
    ...
    let shapeColor = [UIColor(displayP3Red: 250 / 255, green: 92 / 255, blue: 100 / 255, alpha: 1), UIColor(displayP3Red: 233 / 255, green: 235 / 255, blue: 47 / 255, alpha: 1), UIColor(displayP3Red: 81 / 255, green: 180 / 255, blue: 144 / 255, alpha: 1), UIColor(displayP3Red: 46 / 255, green: 94 / 255, blue: 192 / 255, alpha: 1)]
    ...
    func spawnBall () {
        ...
        for _ in 1...80 {
            ...
            let _ = Timer.scheduledTimer(withTimeInterval: 0.7, repeats: true) { _ in
                ...
                let randPlaceY = CGFloat.random(in: 300...800)
